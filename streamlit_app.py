...
if page == pages[0] : 
  ...
  st.dataframe(df.head(10)) # show 1st 10 rows
  st.write(df.shape)
...
if page == pages[2] : 
  st.write("### Modelling")
  # Drop irrelevant variables and separate numerical form categorical variables
  ...
  # Concatenate encoded and numerical
  ...
  #Create function to choose classifier
  ...
  # Create select box to choose model
